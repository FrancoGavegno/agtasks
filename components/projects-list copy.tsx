        ...
        <div className="flex items-center gap-4">
          ...
          >
            ...
            <SelectContent>
              ...
              <SelectItem value="private">Ambientación</SelectItem>
              <SelectItem value="community">DEMO</SelectItem>
              <SelectItem value="private">Ambientación</SelectItem>
              <SelectItem value="community">Templates</SelectItem>
              <SelectItem value="private">Template de recolección de datos de campo</SelectItem>
            </SelectContent>
          </Select>
          <div className="relative flex-1">
            <Search className="absolute left-2 top-2.5 h-4 w-4 text-muted-foreground" />
            <Input
              placeholder="Search projects in space..."
              value={searchQuery}
